...
## Canonical Write-Back Control Rules

The following rules are merged from the prior legacy write_back_protocol.md and are now maintained only in this canonical file.
